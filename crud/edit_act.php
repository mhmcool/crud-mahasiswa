    ...
    if ($foto_size > 2097152) {
       ...
       if ($foto_nama != "") {
          ...
          if(in_array($ekstensi, $ekstensi_izin) === true)  {
            ...
            $query = mysqli_query($koneksi, "UPDATE siswa SET siswa_nama='$nama_lengkap', siswa_email='$email', siswa_jurusan='$jurusan', siswa_fakultas='$fakultas', siswa_foto='$foto_nama_new' WHERE id_siswa='$id'");
    	...
    	// Apabila tidak ada file yang diupload maka akan menjalankan code dibawah ini
          $query = mysqli_query($koneksi, "UPDATE siswa SET siswa_nama='$nama_lengkap', siswa_email='$email', siswa_jurusan='$jurusan', siswa_fakultas='$fakultas', WHERE id_siswa='$id'");
